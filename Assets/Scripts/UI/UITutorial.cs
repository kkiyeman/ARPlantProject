...
public class UITutorial : MonoBehaviour
{
    ...
    void BottomSetBtn(int index)
    {
        ...
        { { "물뿌리개를 이용해 식물에 물을 줄 수 있어요. 수분도가 너무 높거나 낮으면 식물이 죽으니 주의하세요!", "물뿌리개", "CryStr"},
        ...
        { "식물이 자라면 수확이 가능합니다. 식물의 성장도에 따라 보상이 달라집니다.", "Harvest","SmileTalk"},
    ...
    void RightSetBtn(int index)
    {
        ...
        { "상점에서 씨앗, 도구 등 아이템을 구매해보세요! 식물을 키우는 데 도움이 됩니다.","Money","TalkStr" },
        { "키우는 식물의 정보를 도감에서 확인해보세요! 모든 식물을 획득해 도감을 모두 모아보세요!","Dictionary","SmileTalkStr"},
    ...
    void TopSetBtn(int index)
    {
        ...
        string[,] txtList = new string[,] {
         { "현재 날씨와 시간을 알 수 있습니다." ,"뿅", "SmileTalk" },
          ...
          { "상점에서 사용 가능한 골드입니다. 시스템 보상을 받거나 아이템을 팔아 획득 가능합니다.",   "Money","TalkStr"},
        { "","",""},
        { "","",""} };
